...
const CommonForm = ({ viewOnly, addFormProps }) => {
        ...
        <Row>
          <Col xl="12">
            <Form.Group className="form-group mb-2" controlId="formGroupText">
              <Form.Label>
                {addFormProps ? addFormProps.title : "Add pricing Master"}
              </Form.Label>
              <Form.Select
          ...
          {addFormProps && (
            ...
            <Col xl="6">
              <Form.Group className="form-group mb-2" controlId="formGroupText">
                <Form.Label>
                  {addFormProps?addFormProps.fisrtName : ""}
                </Form.Label>
                <Form.Control
                  type="text"
            ...
            <Form.Group className="form-group mb-2" controlId="formGroupText">
              <Form.Label>
                {addFormProps?addFormProps.middleName : ""}
              </Form.Label>
              <Form.Control
                type="text"
          ...
          <Col xl="6">
            <Form.Group className="form-group mb-2" controlId="formGroupText">
              <Form.Label>
                {addFormProps?addFormProps.lastName : ""}
              </Form.Label>
              <Form.Control
                type="text"
          ...
          <Col xl="6">
            <Form.Group className="form-group mb-2" controlId="formGroupText">
              <Form.Label>{addFormProps?addFormProps.companyName:""}</Form.Label>
              <Form.Select
                aria-label="Company Name"
                disabled={viewOnly}
              >
                {
                  addFormProps.companyName?
                  <>
